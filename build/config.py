...
# 1차 운영 데이터 (Experience 신호) — 도어웨이 회피의 근거
DATA_NOTE = (
    "지역별 도착 시간과 시간대 분포는 마사지KOREA가 서울·경기·인천·부산 권역을 "
    "운영하며 축적한 배차 기록을 기준으로 정리한 예상치입니다. "
    "실시간 교통·배차 상황에 따라 달라질 수 있어 예약 시 다시 안내드립니다."
)
